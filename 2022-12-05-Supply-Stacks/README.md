...
```
clang++ -Wall -std=c++20 supply-stacks-part1.cpp -o part1 && ./part1 test.txt
clang++ -Wall -std=c++20 supply-stacks-part1.cpp -o part1 && ./part1
```
...
```
clang++ -Wall -std=c++20 supply-stacks-part2.cpp -o part2 && ./part2 test.txt
clang++ -Wall -std=c++20 supply-stacks-part2.cpp -o part2 && ./part2
```
